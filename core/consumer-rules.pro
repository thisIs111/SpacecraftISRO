...
-keep class com.mosalab.spacecraftisro.core.data.source.remote.response.** { *; }
...
-keep class com.mosalab.spacecraftisro.core.domain.model.** { *; }
-keep class com.mosalab.spacecraftisro.core.domain.repository.** { *; }
-keep class com.mosalab.spacecraftisro.core.domain.usecase.** { *; }
-keep class com.mosalab.spacecraftisro.core.ui.** { *; }

# Keep Kotlin sealed classes (if Resource is a sealed class)
-keep class com.mosalab.spacecraftisro.core.data.Resource { *; }
-keep class com.mosalab.spacecraftisro.core.data.Resource$* { *; }

# Keep DI modules (Koin)
-keep class com.mosalab.spacecraftisro.core.di.** { *; }
